...
namespace WindowsFormsApplication1
{
    public partial class frmPuzzleGame : Form
    {
		...
		// Test case 
		List<int> tesCase1 = new List<int> { 1, 2, 9, 3, 4, 6, 7, 5, 8 }; //trường hợp đb bfs 15
		...
		List<int> tesCase4 = new List<int> { 9, 1, 2, 3, 6, 5, 4, 8, 7 }; //bfs không ra, 
		List<int> tesCase5 = new List<int> { 9, 1, 3, 2, 6, 5, 4, 7, 8 };//bfs 15 nhưng lâu, 
        ...
        private void btnGiai_Click(object sender, EventArgs e) //giải ****
        {
